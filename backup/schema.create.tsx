        ...
        rules: [
          ...
          },
          {
            validator: (rule: any, value: any, callback: any) => {
              if (isNaN(value)) {
                callback('Please input a number.')
              } else {
                callback()
              }
            }
      ...
      if (!err) {
        ...
        const defs = _defKeys.map((def) => {
          ...
          Object.keys(def).forEach((key) => {
            let v
            const o = _defValues[def[key]] // Origin Data
            const t = _defValues[def['type']] // Type
