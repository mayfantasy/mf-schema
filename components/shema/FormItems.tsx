  ...
  return (
    <>
      {_defKeys.map((def: ISchemaFieldDefKeys, index: number) => {
        const currentType = getFieldValue('_defValues')
          ? getFieldValue('_defValues')[def.type]
          : null
              ...
              <Collapse defaultActiveKey={['1']}>
                ...
                >
                  ...
                  >
                    ...
                    {/* Options */}
                    {(currentType === ESchemaFieldType.string_single_select ||
                      currentType === ESchemaFieldType.string_multi_select) && (
                      <Row>
                        <Col span={22}>
                          <Form.Item
                            ...
                            key="options"
                          >
                            {getFieldDecorator(`_defValues[${def.options}]`, {
                              ...(isCreate ? { initialValue: [] } : {})
                            })(
                              <StringArray
                                value={defValuesObject[currentOptionsKey]}
                                onChange={(v) => {
                                  setFieldsValue({
                                    _defValues: {
                                      ...defValuesObject,
